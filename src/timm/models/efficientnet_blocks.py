...
class ConvBnAct(nn.Module):
    ...
    def __init__(
        ...
        self.bn1 = norm_act_layer(out_chs, inplace=True, film=True)
...
class InvertedResidual(nn.Module):
    ...
    def __init__(
        ...
        self.bn2 = norm_act_layer(mid_chs, inplace=True, film=True)
...
class EdgeResidual(nn.Module):
    ...
    def __init__(
        ...
        self.bn1 = norm_act_layer(mid_chs, inplace=True, film=True)
